...
#generator = generator.load_state_dict(torch.load("/home/taiju/pyen/trgan/saved_models/generator_19.pth"))
model_dict = load_state_dict("saved_models/generator_17.pth")
generator.load_state_dict(model_dict, strict=False)

Tensor = torch.cuda.FloatTensor if cuda else torch.Tensor

dataloader = DataLoader(
    ImageDataset("../sr_datasets/Urban100", hr_shape=hr_shape),
